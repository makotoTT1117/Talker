...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <?php if (isset($_SESSION["msgid"]) && $_SESSION["msgid"]!="" && phpShowFeedback($_SESSION["msgid"])[0]!="") { ?>
        <div class="row">
          <div class="col-12">
            <div class="alert alert-<?php echo (phpShowFeedback($_SESSION['msgid'])[0]); ?>" role="alert">
              <?php echo (phpShowFeedback($_SESSION['msgid'])[1]); ?>
            </div>
          </div>
        </div>
    ...
    <script>
      var jsSignUpPassword = document.getElementById("formSignUpEmail");
      var jsSignInPassword = document.getElementById("formSignInEmail");
      ...
      document.getElementById("formSignUpSubmit").disable = true;
      ...
      document.getElementById("formSignInSubmit").disable = true;
      ...
      function jsSignUpValidatePassword(){
        ...
        if(!jsPasswordRegexPattern.test(jsSignUpPassword.value)){
          ...
          if(!document.getElementById("formSignUpPasswordConfInvalidFeedback")){
            ...
            newElement.classList.add("invalid-feedback");
            var newElementContent = document.createTextNode("Password don't match!");
            newElement.appendChild(newElementContent);
          ...
          if(document.getElementById("formSignUpPasswordConfInvalidFeedback")){
            document.getElementById("formSignUpPasswordConfInvalidFeedback").parentElement.removeChild(document.getElementById("formSignUpPasswordInvalidFeedback"));
          }
